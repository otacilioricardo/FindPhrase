...
# As frases são geradas aleatoriamente, mas algumas são substituídas.
...
def main():
	...
	try:
		...
		for i in range(0, 1000000):
			lista = []
			lista = (generate_seed(strength1, 'en')).split()
